...
function Home(){
 ...
 <section id="sobre" className="container about"><div><p className="muted-label">Sobre</p><p className="about-text">Um arquivo autoral de Bernardo Rodrigues Caldeira. Trazendo sempre o combinado de ser atualizado quando houver algo relevante a ser dito.</p></div></section><Footer/></main>
}
